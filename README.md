# Price Guru
Сервис сбора данных с торговых площадок по конкретным запросам с функцией формирования массива данных и пополнения ранее созданных - тз хакатона. Результат - парсер wildberries, масштабируемый под другие платформы.
# Демонстрация
